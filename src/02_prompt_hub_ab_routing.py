...
# Tên duy nhất trong Hub của bạn (đổi nếu muốn)
PROMPT_V1_NAME = "duong-quang-khai-rag-prompt-v1"
PROMPT_V2_NAME = "duong-quang-khai-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
# SYSTEM_V1 — phong cách ngắn gọn, thân thiện, trả lời 2-4 câu
SYSTEM_V1 = (
...
# SYSTEM_V2 — phong cách chuyên gia, có cấu trúc, 3-5 câu
SYSTEM_V2 = (
